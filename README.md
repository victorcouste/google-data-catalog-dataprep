...
<img src="https://github.com/victorcouste/google-data-catalog-dataprep/raw/main/images/dataprep_datacatalog.png" width="80%" height="80%">
...
And to trigger it from a Cloud Dataprep flow, you can use a [Webhook](https://docs.trifacta.com/display/DP/Create+Flow+Webhook+Task) on the Cloud Function endpoint with ```{"job_id":"$jobId"}``` in the POST body.
